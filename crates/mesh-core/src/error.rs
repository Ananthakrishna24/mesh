...
impl Display for CoreError {
    fn fmt(&self, f: &mut Formatter<'_>) -> FmtResult {
        match self {
            ...
            Self::InvalidDeploymentId(value) => write!(f, "invalid deployment id: {value}"),
            Self::InvalidReservationId(value) => write!(f, "invalid reservation id: {value}"),
            Self::InvalidRequestId(value) => write!(f, "invalid request id: {value}"),
